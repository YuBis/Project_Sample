...
public class GameCharacter : BaseObject
{
    ...
    public CharacterTemplateData CHARACTER_DATA { get; private set; }
    public StatSheetData STAT_SHEET_DATA { get => m_statSheetData; private set { m_statSheetData = value; } }
    ...
    virtual public void Initialize(string templateKey, TeamType teamType)
    {
        ...
        CHARACTER_DATA = CharacterTemplateManager.Instance.GetData(TEMPLATE_KEY);
        ...
        STAT_SHEET_DATA = StatSheetManager.Instance.GetData(CHARACTER_DATA.STAT_SHEET);
    ...
    public virtual void UseSkill(SkillInstanceData skillInstance, params GameCharacter[] targets)
    {
        ...
        var skillData = SkillTemplateManager.Instance.GetData(skillInstance.KEY);
        if (skillData == null)
            return;
