...
public class ObjectPoolManager : BaseManager<ObjectPoolManager>
{
    ...
    {
        Universe.StartCoroutine(_UpdatePoolData());
    }

    IEnumerator _UpdatePoolData()
    {
    ...
    public void GetObject(string prefabName, Action<GameObject> callBack, bool bActive = true)
        => Universe.StartCoroutine(_GetObject(prefabName, callBack, bActive));

    IEnumerator _GetObject(string prefabName, Action<GameObject> callBack, bool bActive = true)
    {
        ...
        yield return _MakeNewPrefabObject(prefabName, callBack, bActive);
    }
    ...
    IEnumerator _MakeNewPrefabObject(string prefabName, Action<GameObject> callBack, bool bActive)
    {
