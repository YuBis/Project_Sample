...
public class BoardManager : BaseManager<BoardManager>
{
    ...
    public void MakeBoard(GameCharacter owner, BoardType boardType, Action<BaseBoard> callBack = null)
    {
        if (m_boardData == null)
            return;
    ...
    void _CallbackMakeBoard(GameCharacter owner, BaseBoard boardObj, Action<BaseBoard> finalCallback)
    {
